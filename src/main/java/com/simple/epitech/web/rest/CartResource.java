...
import com.simple.epitech.domain.Cart;
import com.simple.epitech.repository.CartRepository;
...
public class CartResource {
    ...
    public ResponseEntity<Cart> getCart(@PathVariable Long id) {
        ...
        return Optional.ofNullable(cartRepository.findOneWithEagerRelationships(id))
            .map(cart -> new ResponseEntity<>(
                cart,
                HttpStatus.OK))
